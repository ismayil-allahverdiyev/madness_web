...
export function ContactLargeView() {
    ...
    return <div className="flex flex-col items-center justify-center w-1/3 text-white absolute inset-0 mx-auto my-auto z-0">
        <motion.h6 initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 2 }} className="text-center leading-tight font-title tracking-wider sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-3xl">Zaman kaybetme<br />
            güç <br />
            beklemeyecek
        </motion.h6>
